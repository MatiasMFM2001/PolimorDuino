...
//#include "CLASE_WrapperPuntero.h"
    ...
    template <typename TValor> size_t imprimirDatoJSON(Print& impresora, const TValor* valor);
    ...
    template <typename TNombre> size_t imprimirCabeceraJSON(Print& impresora, const TNombre* nombreClase, bool objetoVacio = false) {
    ...
    size_t imprimirCabeceraJSON(Print& impresora, const TNombre* nombreClase, bool objetoVacio) 
#endif
